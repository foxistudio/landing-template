...
function initialize_contact_text_map_map() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(56.8729517, 53.2088865),
    ...
    var contentString = '<div id="content"> Холмогорова 17</div>';
    ...
    var myLatLng = new google.maps.LatLng(56.8729517, 53.2088865);
...
//						CONTACT FORM VALIDATION'S SETTINGS
//------------------------------------------------------------------------------------
$('#popup-form-halfbg--0-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		Phone: "required",
...
$('#popup-form-halfbg--0-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    var $fields = $(this).find('.form-group, div.radio');
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
	$('#popup-form-halfbg--0-form').find('[type=submit]').button('complete');
},
            error: function () {
	$('#popup-form-halfbg--0-form').find('[type=submit]').button('reset');
}
        });
    } else {
        //if data was invalidated
